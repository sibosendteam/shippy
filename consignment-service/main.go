...
import (
	...
	pb "sibosend-shippy/consignment-service/proto/consignment"
	userService "sibosend-shippy/user-service/proto/auth"
	vesselProto "sibosend-shippy/vessel-service/proto/vessel"
)
...
func AuthWrapper(fn server.HandlerFunc) server.HandlerFunc {
	return func(ctx context.Context, req server.Request, resp interface{}) error {
		...
		//log.Println("Meta:", string(metaData))
		if !ok {
		...
		authClient := userService.NewAuthClient("user", srv.Client())
